...
//    }
    ...
    public static void startActivity(Context context, Class className, HashMap<String,String> map){
        Intent intent = new Intent(context,className);
        try {
            for (String key : map.keySet()) {
                ...
                if(value instanceof String){
                    ...
                    intent.putExtra(key,Boolean.parseBoolean(String.valueOf(value)));
    ...
    public static void startActivityFinish(Context context,Class className){
        Intent intent = new Intent(context,className);
        context.startActivity(intent);
        ((Activity)context).finish();
    }

    public static void startSchemeIntent(Context context,String url){
    ...
    public static void startNewSchemeIntent(Context context,String url){
        if(url != null && !"".equals(url)){
            Intent intent = new Intent();
    ...
    public static void startSchemeIntentWithFinish(Context context, String url){
        if(url != null && !"".equals(url)){
            Intent intent = new Intent();
            intent.setAction("android.intent.action.VIEW");
            Uri content_url = Uri.parse(url);
    ...
    public static void startFragmentForResult(Fragment fragment, Context context, Class className) {
        Intent intent = new Intent(context, className);
        fragment.startActivityForResult(intent, Activity.RESULT_FIRST_USER);
    }

    public static void startFragmentForResult(Fragment fragment, Context context, Class className, HashMap<String, String> map) {
        Intent intent = new Intent(context, className);
        try {
            for (String key : map.keySet()) {
                Object value = map.get(key);
