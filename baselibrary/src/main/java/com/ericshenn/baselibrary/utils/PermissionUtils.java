...
public final class PermissionUtils {
    ...
    public final static String[] permsAll = {Manifest.permission.READ_EXTERNAL_STORAGE,
    ...
    public final static String[] permsFile = {Manifest.permission.READ_EXTERNAL_STORAGE,
            Manifest.permission.WRITE_EXTERNAL_STORAGE};
