...
public class GSONUtils {
    ...
    public static <T> T fromJson(String json, TypeToken<T> token, String datePattern) {
        ...
        try {
            ...
            Log.e("ws", " 无法转换为 " + token.getRawType().getName() + " 对象!异常原因：" + ex.getMessage());
            return null;
        }
    }
    ...
    public static <T> T fromJson(String json, Class<T> clazz, String datePattern) {
        ...
        try {
            ...
            Log.i("ws", json + " 无法转换为 " + clazz.getName() + " 对象!异常原因：" + ex.getMessage());
            return null;
        }
    }
    ...
    public static String toJson(Object target, Type targetType, GsonBuilder builder) {
        ...
        try {
            ...
            Log.i("ws", "目标对象 " + target.getClass().getName() + " 转换 JSON 字符串时，发生异常！异常原因：" + ex.getMessage());
        ...
        try {
            ...
            for (Field field : declaredFields) {
                ...
                if (field.get(obj) instanceof Integer) {
                    Integer temp = Integer.parseInt(String.valueOf(field.get(obj)));
                    if (temp != null) {
