package com.ericshenn.baselibrary.view.pacificadapter;
...
//            int temp = ((GridLayoutManager) parent.getLayoutManager()).getSpanCount();
//            int quotient = parent.getChildCount() / temp;
//            int remainder = parent.getChildCount() % temp;
//
//            if (remainder == 0) {
//                spanCount = quotient;
//            } else {
//                spanCount = quotient + 1;
//            }
//        } else {
            spanCount = parent.getChildCount();
//        }

        int childCount = mShowLastDivider ? spanCount : spanCount - 1;
