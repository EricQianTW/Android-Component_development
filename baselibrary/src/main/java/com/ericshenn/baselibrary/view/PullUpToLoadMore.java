...
public class PullUpToLoadMore extends ViewGroup {
    ...
    PullUpToLoadMoreScrollView topScrollView, bottomScrollView;
    ...
    private void init() {
        ...
        post(new Runnable() {
            @Override
            public void run() {
                topScrollView = (PullUpToLoadMoreScrollView) getChildAt(0);
                bottomScrollView = (PullUpToLoadMoreScrollView) getChildAt(1);
                topScrollView.setScrollListener(new PullUpToLoadMoreScrollView.ScrollListener() {
                    @Override
                ...
                bottomScrollView.setScrollListener(new PullUpToLoadMoreScrollView.ScrollListener() {
                    @Override
                    public void onScrollToBottom() {
