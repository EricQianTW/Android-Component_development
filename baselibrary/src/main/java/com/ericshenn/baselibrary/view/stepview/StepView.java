...
public class StepView extends RecyclerView {
    ...
    public StepView(Context context, @Nullable AttributeSet attrs, int defStyle) {
        ...
        leftMargin = dp2px(context, DEFAULT_LEFT_MARGIN);
        rightMargin = dp2px(context, DEFAULT_RIGHT_MARGIN);
        lineWidth = dp2px(context, DEFAULT_LINE_WIDTH);
        radius = dp2px(context, DEFAULT_DOT_RADIUS);
        ...
        lineWidth = (int) ta.getDimension(R.styleable.StepView_svlineWidth, lineWidth);
        radius = (int) ta.getDimension(R.styleable.StepView_svradius, radius);
