...
public class StepNodeItemDecoration extends RecyclerView.ItemDecoration{
    ...
    private void initPaint() {
        ...
        ringRadius = radius + dp2px(mBuilder.context, DEFAULT_DOT_STROKE_WIDTH);
        space = dp2px(mBuilder.context, DEFAULT_SPACE);
        ...
        mDotHighRingPaint.setColor(getColorWithAlpha(0.3f, mBuilder.highDotColor));
