...
import com.ericshenn.test.R;
import com.ericshenn.test.ToolbarActivity2;
...
public class DebugActivity extends BaseActivity  implements BGASwipeBackHelper.Delegate{
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        refreshLayout.setOnLoadmoreListener(new OnLoadmoreListener() {
            ...
            public void onLoadmore(RefreshLayout refreshlayout) {
                ToastUtils.showShort("sadasfddasdasdasd");
...
//                });
        ...
        tv_mine.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                IntentUtils.startActivity(DebugActivity.this, ToolbarActivity2.class);
            }
        });
    }
