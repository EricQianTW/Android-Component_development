package com.ericshenn.dialogui;
...
import com.ericshenn.dialogui.bean.BuildBean;
import com.ericshenn.dialogui.bean.TieBean;
import com.ericshenn.dialogui.listener.DialogAssigner;
import com.ericshenn.dialogui.listener.DialogUIDateTimeSaveListener;
import com.ericshenn.dialogui.listener.DialogUIItemListener;
import com.ericshenn.dialogui.listener.DialogUIListener;
import com.ericshenn.dialogui.listener.TdataListener;
import com.ericshenn.dialogui.utils.ToolUtils;
import com.ericshenn.dialogui.widget.PopuWindowView;
...
public class DialogUIUtils {
     ...
     * @return
     */
    public static BuildBean showCustomBottomAlert(Context context, View contentView, boolean isWhiteBg) {
        return showCustomBottomAlert(context, contentView, true, true, isWhiteBg);
    }
     ...
     * @return
     */
    public static BuildBean showCustomBottomAlert(Context context, View contentView, boolean cancleable, boolean outsideTouchable, boolean isWhiteBg) {
        return DialogAssigner.getInstance().assignCustomBottomAlert(context, contentView, cancleable, outsideTouchable, isWhiteBg);
    }
