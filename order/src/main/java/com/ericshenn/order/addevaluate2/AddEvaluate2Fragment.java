...
public class AddEvaluate2Fragment extends BaseFragment implements AddEvaluate2Contract.View {

    private AddEvaluate2Contract.Presenter mPresenter = new AddEvaluate2Presenter(this);
    ...
    public int setLayoutId() {
        return R.layout.addevaluate2_frg;
    }
    ...
    protected void initAdapter() throws Exception {
        adapter = new RecyclerAdapter<EvaluatePicInfo>(getContext(), R.layout.addevaluate_adp) {
            ...
            protected void convert(final RecyclerAdapterHelper helper, final EvaluatePicInfo info) {
                ...
                Glide.with(AddEvaluate2Fragment.this).load(info.getPath()).into(ivEvaluate);
                ...
                dialog.setOnOperItemClickL(new OnOperItemClickL() {
                    ...
                    public void onOperItemClick(AdapterView<?> parent, View view, int position, long id) {
                        ...
                        if (position == 0) {
                            ...
                            AddEvaluate2Fragment.this.startActivityForResult(intent, Const.ALBUMLIST);
                        }
                        dialog.dismiss();
                    }
                });
